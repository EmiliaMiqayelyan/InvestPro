export const en = {
  ...
  landing: {
    ...
    investorPoints: {
      p1: "Curated marketplace of verified listings",
      p2: "Membership tiers for deeper diligence access",
      p3: "Structured offers and on-platform messaging",
    ...
    faqs: {
      ...
      a1: "Project owners create an account, complete profile details, and submit projects for review before they appear in the marketplace.",
  ...
  projects: {
    ...
    accessLimited: "Upgrade to Premium to unlock full project details, documents, and team.",
    upgradeMembership: "Upgrade membership",
    gatedContent: "Gated content",
    gatedBody:
      "Some details are limited by your membership. Upgrade to unlock documents, team, and financials.",
    ...
    lockedLabel: "{label} is available with Premium membership or higher.",
    ...
    toastMessagePremium: "Premium membership required to message owners.",
    toastConversationStarted: "Conversation started.",
    toastOfferLogin: "Investors must be signed in to send offers.",
    toastOfferPremium: "Premium membership required to send offers.",
    ...
    toastPremiumRequired: "Premium membership required.",
  },
  risk: {
    ...
    summary: "Summary",
    limited: "Limited preview — upgrade membership for the full report.",
    unavailable:
      "Risk analysis is unavailable. You may need a membership or the project may not be published.",
  ...
  membership: {
    ...
    eyebrow: "Membership",
    heroTitle: "Unlock full marketplace access",
    subtitle: "Choose the access level that matches your investment workflow.",
    heroSub:
      "Investor memberships open documents, team profiles, financial analysis, messaging, and investment offers. Choose the tier that matches how you diligence deals.",
    monthly: " / month",
    ...
    loginRequired: "Sign in as an investor to purchase membership.",
    loginRequiredShort: "Sign in as an investor to subscribe.",
    investorOnly: "Membership plans are available to investor accounts only.",
    ...
    subscribed: "Subscribed to {plan} successfully.",
  },
  investor: {
