...
import { ArrowRight, Building2, FileCheck, Handshake, Users } from "lucide-react";
...
export default function ForOwnersPage() {
  ...
  const blocks = [
    ...
    { icon: FileCheck, title: t("forOwnersPage.b2Title"), body: t("forOwnersPage.b2Body") },
    { icon: Handshake, title: t("forOwnersPage.b3Title"), body: t("forOwnersPage.b3Body") },
    { icon: Users, title: t("forOwnersPage.b4Title"), body: t("forOwnersPage.b4Body") },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <CtaBand title={t("landing.forOwnersCta")} description={t("forOwnersPage.heroSub")}>
